...
from pie_core.annotations import (
    BinaryRelation,
    Label,
    LabeledMultiSpan,
    LabeledSpan,
...
from pie_core.document import AnnotationLayer, Document, annotation_field
...
class TokenBasedDocument(WithMetadata, WithTokens, Document):
    def __post_init__(self) -> None:
        ...
        # When used in a dataset, the document gets serialized to json like
        # structure which does not know tuples, so they get converted to lists.
        # This is a workaround to automatically convert the "tokens" back to
        # tuples when the document is created from a dataset.
